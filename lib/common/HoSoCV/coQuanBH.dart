...
class _coQuanBH extends State<coQuanBH> {
                ...
                // color: Colors.red,
                  ...
                  child: (selectedItem.isEmpty
                    ...
                    child: Text(widget.title != null
                      ...
                      itemCount: checkExist(selectedItem).length,
...
class DropDownListItem extends StatefulWidget {
  ...
  final String searchHintText;
  final List<ListDataCQ> listData;
...
class DropDownListItemState extends State<DropDownListItem> {
  List<ListDataCQ> dataList = [];
  List<ListDataCQ> dataListAll = [];
  ...
  void filterSearch(String query) {
    if (query.isNotEmpty) {
      List<ListDataCQ> lstVanBanSearch = [];
      widget.listData.forEach((element) {
        ListDataCQ d = element;
        if (d.text.toLowerCase().contains(query) ||
            d.text.toUpperCase().contains(query)) {
      ...
      if (mounted) {
        setState(() {
          dataList.clear();
          List<ListDataCQ> lstVanBanSearchAll = [];
          widget.listData.forEach((element) {
            ListDataCQ d = element;
