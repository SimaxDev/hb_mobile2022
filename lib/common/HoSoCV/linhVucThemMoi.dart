...
class linhVucHSCV extends StatefulWidget {
  final String title;
...
class linhVucHSCVState extends State<linhVucHSCV> {
    ...
    showGeneralDialog(
        ...
        pageBuilder: (BuildContext buildContext, Animation animation,
          ...
          return DropDownListItem(
              ...
              listDataLinhVuc: widget.listDataLinhVuc,
...
class DropDownListItem extends StatefulWidget {
  ...
  final String searchHintText;
  final List<ListDataLinhVuc> listDataLinhVuc;
...
class DropDownListItemState extends State<DropDownListItem> {
  List<ListDataLinhVuc> dataList = [];
  List<ListDataLinhVuc> dataListAll = [];
  @override
  void initState() {
    super.initState();
    this.getBody();
    dataListAll = widget.listDataLinhVuc;
    if(dataListAll != null) {
  ...
  void filterSearch(String query) {
    if (query.isNotEmpty) {
      List<ListDataLinhVuc> lstVanBanSearch = [];
      dataListAll.forEach((element) {
        ListDataLinhVuc d = element;
      ...
      setState(() {
        dataList.clear();
        List<ListDataLinhVuc> lstVanBanSearchAll = [];
        dataListAll.forEach((element) {
          ListDataLinhVuc d = element;
