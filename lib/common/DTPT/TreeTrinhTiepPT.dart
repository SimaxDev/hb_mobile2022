...
class _TreeTrinhTiepPTState extends State<TreeTrinhTiepPT> {
      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: [
              ...
              children: [
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text('Về việc:', style: TextStyle(fontWeight:
                      FontWeight.bold)),
                    ),
                    Container(
                        ...
                        child:Padding(
                          ...
                          child: Text("", style: TextStyle(fontSize: 14),textAlign: TextAlign.left,),
                        )
                ...
                Row(
                  ...
                  children: [
                    Container(
                      width: MediaQuery.of(context).size.width * 0.15,
                      child: Text('Tóm tắt nội dung:', style: TextStyle(fontWeight:
                      FontWeight.bold)),
                    ),
                    Container(
                        decoration: BoxDecoration(
            ...
            //           child: Text('Hạn xử lý:', style: TextStyle(fontWeight: FontWeight.bold)),
            //         ),
            //         Padding(
            ...
            //         Container(
            //           child:
            //               Text("Gửi tin nhắn thông báo", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
            //         ),
            //         Checkbox(
            //             value: PH,
            //             onChanged: (val) {
