...
//   TextColumn get name => text().withLength(min: 1, max: 5000000)();
...
//         .go();
//   }
//   Future<List<Task>> getPaged(int limit, int offset) {
//     return (select(tasks)..limit(limit, offset: offset)).get();
//   }
//
//   Future<Task> getTaskById(int id) {
//     return (select(tasks)..where((e) => e.id.equals(id))).getSingle();
//   }
// }
