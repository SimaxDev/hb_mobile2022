...
class _NhatKyVBDi extends State<NhatKyVBDi> {
    ...
    if (response.statusCode == 200) {
      ...
      isLoading.value = true;
        ...
        for (var element in items) {
          var aaa = element['infoGroupNameReceivedText'] != null ?element['infoGroupNameReceivedText'].split('#')[1]:
          "";
          var ten =  element['infoSentByUser']['Title'] != null ? element['infoSentByUser']['Title']: "";
          var infoUserNameReceivedID =  element['infoUserNameReceived']!=
              null ?
          element['infoUserNameReceived']['ID']: 0;
          var tenNguoi =  element['infoUserNameReceived']['Title'] != null
              ?element['infoUserNameReceived']['Title']: "";
          ten == "" || aaa ==  ""? 0 :
          listNhatKy.add(SingleChildScrollView(
            child:
            Row(
              children: [
                Column(children: [
                  infoUserNameReceivedID >0 ?Column(children: [
                    Row(
                      children: [
                        Container(
                        ...
                        Container(
                          ...
                          child:Column(children: [
                            Text(tenNguoi),
                            getTrangThaiNoiNhan(element['ttThuHoi']) !=  ""?
                            Text("(" +getTrangThaiNoiNhan(element['ttThuHoi'])+ ")",style:TextStyle(fontSize: 13,
                    ...
                    Row(children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          //     : '',
                          GetDate(element['infoTimeSent'].toString()),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child:Scaffold(
      body: Obx(()=>isLoading == true?getBody()
          : Center(child: CircularProgressIndicator(valueColor: new
