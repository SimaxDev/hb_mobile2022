...
class _MenuRightState extends State<MenuRight> {
  ...
  Widget GetBodyMenuVBDDT(item) {
    var title = item['TenGroup'] !=
        null?item['TenGroup']:"";
    int IDVBDT=  item['IDGroup']!= null?item['IDGroup']:0;
    return OrganName  ==title ?Container(): ListTile(
        title: Text(
         "+ "+ title,
          maxLines: 2,style: TextStyle(color: Colors.lightBlue,fontSize: 13),
        ),
            ...
            Navigator.of(context).pushAndRemoveUntil(
                MaterialPageRoute(
                    builder: (BuildContext context) => BottomNavigator
                      (username:widget.users,IDDonVi:IDVBDT)),
    ...
    return GestureDetector(
      ...
      child:  ListView(
        children: <Widget>[
          ...
          lstThongTinGroup.length>1? Column(children: [
            Container(
              alignment: Alignment.center,
            ...
            Column(children: [
              Container(
                ...
                child:new Text("- Chọn đơn vị khác để làm việc:",
                  style: TextStyle(
                    decoration: TextDecoration.underline,),
                ),
              ),
          ...
          ListTile(
            ...
            onTap: (){
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ThongtinUser(username:widget.users),
                  ));
            },
          ),
            ...
            onTap: (){
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                    ...
                    builder: (context) => EditPassWord(tendangnhap: widget.users),
                  ));
            },
          ),
          ListTile(
