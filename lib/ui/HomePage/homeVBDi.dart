...
class HomeVBDi extends StatefulWidget {
  final returnData;
  final String username;

  HomeVBDi({Key? key, this.returnData, required this.username}) : super(key: key);
...
class PageState extends State<HomeVBDi> {
  //properties
  List dataListVBDi = [];
  ...
  Widget getBodyVB(item, int index) {
    ...
    return Card(
      child: ListTile(
          ...
          onTap: () {
            Get.offAll(BottomNavigator(query: query,page:2, username: '', year: '', ID: 0,index: 0,) );
