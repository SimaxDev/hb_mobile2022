...
class HSCVWidget extends StatefulWidget {
  ...
  String nam = "2022";
  HSCVWidget({Key key, this.urlLoaiVB,this.val,this.username, this.pageindex,this.nam}) : super(key: key);
...
class HSCVState extends State<HSCVWidget> {
  ...
  bool showD = true;
  List<String> Year = [ttHoSo(0),ttHoSo(1),ttHoSo(2),ttHoSo(3),
    ttHoSo(4),ttHoSo(5),ttHoSo(6)];
  ...
  GetDataByKeyYearVBDi(String trangthai) async {
    String yeartimkiem = await getDataByKeyTrangThai1( ActionXL, trangthai,
              ...
              child:   DropdownButton<String>(
                ...
                onChanged: (String newValue) {
                  setState(() {
                    ...
                    GetDataByKeyYearVBDi(_user.toString());
                  });
                },
        ...
        child: new ListView(
          children: <Widget>[
            ...
            Container(
              ...
              child: MenuLeft(page: 4,username:widget.username,year: nam1,
                queryID: IDTT,),
            )
          ],
        ),
...
// các thẻ con trong list view
  Widget getCard(item) {
    var hscvTrangThaiXuLy = item['hscvTrangThaiXuLy'] != null ? item['hscvTrangThaiXuLy'] : 0;
    var hscvNguoiLap = item['hscvNguoiLap']['Title'] != null  ?item['hscvNguoiLap']['Title'] :  0 ;
    ...
    var temp =  DateFormat("yyyy-MM-dd").parse(item['hscvNgayMoHoSo']) != null ?DateFormat("yyyy-MM-dd").parse
      (item['hscvNgayMoHoSo']) : DateFormat("yyyy-MM-dd").parse(item['hscvNgayMoHoSo']);
    var hscvNgayMoHoSo = DateFormat("dd-MM-yyyy").format(temp);
   var temp1 =  DateFormat("yyyy-MM-dd").parse(item['hscvNgayMoHoSo']) !=
       null ?DateFormat("yyyy-MM-dd").parse
     (item['hscvNgayMoHoSo']) : DateFormat("yyyy-MM-dd").parse
    (item['hscvNgayMoHoSo']);
    var hscvHanXuLy = DateFormat("dd-MM-yyyy").format(temp1);
    return Card(
        elevation: 1.5,
        child: InkWell(
          onTap: () {
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child:  ListTile(
                          ...
                          subtitle: Text(
                              hscvNgayMoHoSo,style: TextStyle(height: 1.5),
                          ),
                        ),
                      ),
            ...
            child:   Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child:
                  (DMDescription != null && DMDescription.contains
                  ("#DaChuyenVT#")) ?
                  Column(
                    children: [
                      Text(trangthaiState,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        // width: MediaQuery.of(context).size.width * 0.3,
                        child: Text( hscvHanXuLy == null|| hscvHanXuLy == "" ?"":
                        "(" + hscvHanXuLy + ")" ,
                          //  overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              color: Colors.black38,
    ...
    switch (type) {
      case 1:
        list.sort((a, b) => isSort
            ? Comparable.compare(b["hscvNgayMoHoSo"],
            a["hscvNgayMoHoSo"]):Comparable.compare(a["hscvNgayMoHoSo"],
            b["hscvNgayMoHoSo"]));
        break;
      case 0:
        list.sort((a, b) => isSort
      ...
      case 3:
        list.sort((a, b) => isSort
            ? Comparable.compare(b["hscvNguoiLap"]["Title"],
            a["hscvNguoiLap"]["Title"]):Comparable.compare(a["hscvNguoiLap"]["Title"],
            b["hscvNguoiLap"]["Title"]));
        break;
      case 2:
        list.sort((a, b) => isSort
            ?Comparable.compare(b["hscvHanXuLy"],
            a["hscvHanXuLy"]): Comparable.compare(a["hscvHanXuLy"],
            b["hscvHanXuLy"]));
        break;
    }
